function costs = cmaesParallelSplitRough(gainsPop)
    ...
    for i = 1:numTerrains:(numTerrains*popSize)
        ...
        paramSets{i} = Simulink.BlockDiagram.modifyTunableParameters(rtp, ...
            ...
            'LtransSupst_C',             Gains(131), ...
            'Ltranssw_C',                Gains(132), ...
            'LPreStimHABst',             Gains(133), ...
            'LPreStimHADst',             Gains(134), ...
            'LPreStimHABsw',             Gains(135), ...
            'LPreStimHADsw',             Gains(136), ...
            'RGainFHABst',               Gains(137), ...
            'RGainPhiHATHABst',          Gains(138), ...
            'RGainDphiHATHABst',         Gains(139), ...
            'RGainPhiHATHADst',          Gains(140), ...
            'RGainDphiHATHADst',         Gains(141), ...
            'RGainSHABcHABst',           Gains(142), ...
            'RGainSHADcHADst',           Gains(143), ...
            'RGainLHABsw',               Gains(144), ...
            'RGainLHADsw',               Gains(145), ...
            'RsimbiconLegAngle0_C',      Gains(146), ...
            'RsimbiconGainD_C',          Gains(147), ...
            'RsimbiconGainV_C',          Gains(148), ...
            'RheadingGain',              Gains(149), ...
            'RtransSupst_C',             Gains(150), ...
            'Rtranssw_C',                Gains(151), ...
            'RPreStimHABst',             Gains(152), ...
            'RPreStimHADst',             Gains(153), ...
            'RPreStimHABsw',             Gains(154), ...
            'RPreStimHADsw',             Gains(155), ...
            'vyInit',                    Gains(156), ...
            'rollInit',                  Gains(157), ...
            'LphiHipR0',                 Gains(158), ...
            'RphiHipR0',                 Gains(159), ...
            'LTargetAngleRInit',         Gains(160), ...
            'LPreStimHABinit',           Gains(161), ...
            'LPreStimHADinit',           Gains(162), ...
            'RTargetAngleRInit',         Gains(163), ...
            'RPreStimHABinit',           Gains(164), ...
            'RPreStimHADinit',           Gains(165));
