function costs = cmaesParallelSplitRough(gainsPop)
    ...
    for i = 1:numTerrains:(numTerrains*popSize)
        ...
        paramSets{i} = Simulink.BlockDiagram.modifyTunableParameters(rtp, ...
            ...
            'phiHATref',                 Gains(97), ...
            'LGainFHABst',               Gains(98), ...
            'LGainPhiHATHABst',          Gains(99), ...
            'LGainDphiHATHABst',         Gains(100), ...
            'LGainPhiHATHADst',          Gains(101), ...
            'LGainDphiHATHADst',         Gains(102), ...
            'LGainSHABcHABst',           Gains(103), ...
            'LGainSHADcHADst',           Gains(104), ...
            'LGainLHABsw',               Gains(105), ...
            'LGainLHADsw',               Gains(106), ...
            'LsimbiconLegAngle0_C',      Gains(107), ...
            'LsimbiconGainD_C',          Gains(108), ...
            'LsimbiconGainV_C',          Gains(109), ...
            'LtransSupst_C',             Gains(110), ...
            'Ltranssw_C',                Gains(111), ...
            'LPreStimHABst',             Gains(112), ...
            'LPreStimHADst',             Gains(113), ...
            'LPreStimHABsw',             Gains(114), ...
            'LPreStimHADsw',             Gains(115), ...
            'RGainFHABst',               Gains(116), ...
            'RGainPhiHATHABst',          Gains(117), ...
            'RGainDphiHATHABst',         Gains(118), ...
            'RGainPhiHATHADst',          Gains(119), ...
            'RGainDphiHATHADst',         Gains(120), ...
            'RGainSHABcHABst',           Gains(121), ...
            'RGainSHADcHADst',           Gains(122), ...
            'RGainLHABsw',               Gains(123), ...
            'RGainLHADsw',               Gains(124), ...
            'RsimbiconLegAngle0_C',      Gains(125), ...
            'RsimbiconGainD_C',          Gains(126), ...
            'RsimbiconGainV_C',          Gains(127), ...
            'RtransSupst_C',             Gains(128), ...
            'Rtranssw_C',                Gains(129), ...
            'RPreStimHABst',             Gains(130), ...
            'RPreStimHADst',             Gains(131), ...
