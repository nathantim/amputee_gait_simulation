function costs = cmaesParallelSplitRough(gainsPop)
    ...
    for i = 1:numTerrains:(numTerrains*popSize)
        ...
        paramSets{i} = Simulink.BlockDiagram.modifyTunableParameters(rtp, ...
            ...
            'LtransSupst_C',             Gains(130), ...
            'Ltranssw_C',                Gains(131), ...
            'LPreStimHABst',             Gains(132), ...
            'LPreStimHADst',             Gains(133), ...
            'LPreStimHABsw',             Gains(134), ...
            'LPreStimHADsw',             Gains(135), ...
            'RGainFHABst',               Gains(136), ...
            'RGainPhiHATHABst',          Gains(137), ...
            'RGainDphiHATHABst',         Gains(138), ...
            'RGainPhiHATHADst',          Gains(139), ...
            'RGainDphiHATHADst',         Gains(140), ...
            'RGainSHABcHABst',           Gains(141), ...
            'RGainSHADcHADst',           Gains(142), ...
            'RGainLHABsw',               Gains(143), ...
            'RGainLHADsw',               Gains(144), ...
            'RsimbiconLegAngle0_C',      Gains(145), ...
            'RsimbiconGainD_C',          Gains(146), ...
            'RsimbiconGainV_C',          Gains(147), ...
            'RtransSupst_C',             Gains(148), ...
            'Rtranssw_C',                Gains(149), ...
            'RPreStimHABst',             Gains(150), ...
            'RPreStimHADst',             Gains(151), ...
            'RPreStimHABsw',             Gains(152), ...
            'RPreStimHADsw',             Gains(153), ...
            'vyInit',                    Gains(154), ...
            'rollInit',                  Gains(155), ...
            'LphiHipR0',                 Gains(156), ...
            'RphiHipR0',                 Gains(157), ...
            'LTargetAngleRInit',         Gains(158), ...
            'LPreStimHABinit',           Gains(159), ...
            'LPreStimHADinit',           Gains(160), ...
            'RTargetAngleRInit',         Gains(161), ...
            'RPreStimHABinit',           Gains(162), ...
            'RPreStimHADinit',           Gains(163));
