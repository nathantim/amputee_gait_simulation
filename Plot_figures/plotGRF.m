...
if false
    plotHandlesLeft = plotGRFDataInFigure(t_left,L_Ball,L_Total,L_Heel);
    plotHandlesRight = plotGRFDataInFigure(t_right,R_Ball,R_Total,R_Heel);
    set(GRFDataFig, 'Position',[10,50,1600,900]);
else
    plotHandlesLeft = plotTotalGRFDataInFigure(t_left,L_Total);
    plotHandlesRight = plotTotalGRFDataInFigure(t_right,R_Total);
