...
totalRange = {  char(strcat('(',num2str(round(stanceRange(1),1)),','," ",num2str(round(stanceRange(2),1)),')'));...
                char(strcat('(',num2str(round(swingRange(1),1)),','," ",num2str(round(swingRange(2),1)),')'))};
