...
for i = 1:numTerrains:(numTerrains*popSize)
    ...
    'LphiHipR0',                 Gains(39), ...
    'RphiHipR0',                 Gains(40), ...
    'LTargetAngleRInit',         Gains(41), ...
    'LPreStimHABinit',           Gains(42), ...
    'LPreStimHADinit',           Gains(43), ...
    'RTargetAngleRInit',         Gains(44), ...
    'RPreStimHABinit',           Gains(45), ...
    'RPreStimHADinit',           Gains(46), ...
    'vxInit',                    Gains(47), ...
    'LphiHip0',                  Gains(48), ...
    'LphiKnee0',                 Gains(49), ...
    'LphiAnkle0',                Gains(50), ...
    'RphiHip0',                  Gains(51), ...
    'LTargetAngleInit',          Gains(52), ...
    'LPreStimHFLinit',           Gains(53), ...
    'LPreStimGLUinit',           Gains(54), ...
    'LPreStimHAMinit',           Gains(55), ...
    'LPreStimRFinit',            Gains(56), ...
    'LPreStimVASinit',           Gains(57), ...
    'LPreStimBFSHinit',          Gains(58), ...
    'LPreStimGASinit',           Gains(59), ...
    'LPreStimSOLinit',           Gains(60), ...
    'LPreStimTAinit',            Gains(61), ...
    'RTargetAngleInit',          Gains(62), ...
    'RPreStimHFLinit',           Gains(63), ...
    'RPreStimGLUinit',           Gains(64), ...
    'RPreStimHAMinit',           Gains(65), ...
    'RPreStimRFinit',            Gains(66));
