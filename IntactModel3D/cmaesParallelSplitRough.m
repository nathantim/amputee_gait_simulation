...
%     [groundX, groundZ, groundTheta] = generateGround('flat');
    ...
    for i = 1:numTerrains:(numTerrains*popSize)
        ...
        paramSets{i} = Simulink.BlockDiagram.modifyTunableParameters(rtp, ...
            ...
            'phiHATref',                Gains(64), ...
            'GainFHABst',               Gains(65), ...
            'GainPhiHATHABst',          Gains(66), ...
            'GainDphiHATHABst',         Gains(67), ...
            'GainPhiHATHADst',          Gains(68), ...
            'GainDphiHATHADst',         Gains(69), ...
            'GainSHABcHABst',           Gains(70), ...
            'GainSHADcHADst',           Gains(71), ...
            'GainLHABsw',               Gains(72), ...
            'GainLHADsw',               Gains(73), ...
            'simbiconLegAngle0_C',      Gains(74), ...
            'simbiconGainD_C',          Gains(75), ...
            'simbiconGainV_C',          Gains(76), ...
            'transSupst_C',             Gains(77), ...
            'transsw_C',                Gains(78), ...
            'PreStimHABst',             Gains(79), ...
            'PreStimHADst',             Gains(80), ...
    ...
    try
        ...
        if inner_opt_settings.visual
            if ~isempty(fieldnames(dataStruct(idx2send)))
                dataStruct(idx2send).optimCost = costs(idx2send);
