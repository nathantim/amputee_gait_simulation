...
PosGainGGHAB    = 0.1;%6.0570;        %[1/rad]
PosGainGGHAD    = 0.1;%0.4399;        %[1/rad]

% stance hip joint speed gain
SpeedGainGG     = 0.2;    %[s/rad] 
SpeedGainGGHAB  = 0.1;%1.1503; %[s/rad]
SpeedGainGGHAD  = 0.0219; %[s/rad] 
...
hipPGainAbd = 1; %[Nm/rad]
hipDGainAbd = 0.5; %[Nms/rad]
...
simbiconLegAngle0Abd = -0.0133;
simbiconGainDAbd = 0.1421; %[rad/m]
simbiconGainVAbd = 0.2148; %[rad s/m]
