...
plotSelected = [str2num(input(['\nWhich results do you want to plot? \n '...
    ...
    ' You can select multiple simulations or leave it empty           '],'s'))];
...
animView = '''perspective''';
animationCommands = {...
    ['animPost(healthy3D09.simout.animData3D,''intact'',true,''obstacle'',false,''view'',' animView ',''CMG'',false,''info'',''Healthy 0.9m/s'',''createVideo'',' b_createVideo ');'];...
    ['animPost(healthy3D12.simout.animData3D,''intact'',true,''obstacle'',false,''view'',' animView ',''CMG'',false,''info'',''Healthy 1.2m/s'',''createVideo'',' b_createVideo ');'];...
    ['animPost(prosthetic3D09.simout.animData3D,''intact'',false,''obstacle'',false,''view'',' animView ',''CMG'',false,''info'',''Amputee 0.9m/s'',''createVideo'',' b_createVideo ');'];...
    ['animPost(prosthetic3D12.simout.animData3D,''intact'',false,''obstacle'',false,''view'',' animView ',''CMG'',false,''info'',''Amputee 1.2m/s'',''createVideo'',' b_createVideo ');'];...
    ['animPost(prosthetic3DCMGNOTActive.simout.animData3D,''intact'',false,''obstacle'',false,''view'',' animView ',''CMG'',true,''info'',''Amputee with inactive CMG'',''createVideo'',' b_createVideo ')'];...
    ['animPost(prosthetic3DCMGActive.simout.animData3D,''intact'',false,''obstacle'',false,''view'',' animView ',''CMG'',true,''info'',''Amputee with active CMG'',''createVideo'',' b_createVideo ')'];...
    ['animPost(prosthetic3DCMGTripFall.simout.animData3D,''intact'',false,''obstacle'',true,''view'',' animView ',''CMG'',true,''info'',''Amputee trip fall'',''createVideo'',' b_createVideo ')'];...
    ['animPost(prosthetic3DCMGTripPrevent.simout.animData3D,''intact'',false,''obstacle'',true,''view'',' animView ',''CMG'',true,''info'',''Amputee trip prevention'',''createVideo'',' b_createVideo ')'];};
