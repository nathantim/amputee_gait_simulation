function SphereObjects = createSphereObjects3D(SphereRes, yShift, rCP, rAJ, rKJ, rHJ, intactFlag, yShiftGlobal)
    ...
    L_Ball1 = surf(rCP*x, rCP*y + yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
    L_Heel = surf(rCP*x, rCP*y + yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
    L_Heel1 = surf(rCP*x, rCP*y + yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
    ...
    if(intactFlag)
        ...
        R_Ball1 = surf(rCP*x, rCP*y - yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
        R_Heel = surf(rCP*x, rCP*y - yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
        R_Heel1 = surf(rCP*x, rCP*y - yShift + yShiftGlobal, rCP*z, 'FaceColor', ContPointCol2);
        ...
        SphereObjects = [L_HJ; L_Ball; L_Ball1; L_Heel; L_Heel1; L_AJ; L_KJ; R_HJ; R_Ball; R_Ball1; R_Heel; R_Heel1; R_AJ; R_KJ];
    else
        material shiny
        % generate objects vector
        SphereObjects = [L_HJ; L_Ball; L_Ball1; L_Heel; L_Heel1; L_AJ; L_KJ; R_HJ];
    end
