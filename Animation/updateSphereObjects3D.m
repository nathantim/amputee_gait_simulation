...
function updateSphereObjects3D( SphereObjects, u, x, yShift, intactFlag, CMGFlag)
    ...
    if(~intactFlag)
        set(R_KJ2_Obj, 'XData',  get(R_KJ2_Obj, 'XData') +  u(35) - x(35), ...
        'YData',  get(R_KJ2_Obj, 'YData') +  u(36) - x(36), ...
        'ZData',  get(R_KJ2_Obj, 'ZData') +  u(37) - x(37))
    end
    if (CMGFlag)
       set(CMG_obj, 'XData',  get(CMG_obj, 'XData') +  u(38) - x(38), ...
        'YData',  get(CMG_obj, 'YData') +  u(39) - x(39), ...
        'ZData',  get(CMG_obj, 'ZData') +  u(40) - x(40))
    end
end
