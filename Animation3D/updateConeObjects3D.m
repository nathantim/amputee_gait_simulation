...
function updateConeObjects3D( ConeObjects, u, x, t, intactFlag)
    ...
    if false %(~intactFlag)
        R_KneeProsthObj = ConeObjects(10);
    end
    ...
    if t==0
        ...
        if false %(~intactFlag)
            ...
            R_KneeProsthLength = sqrt( (u(22)-u(25))^2 + (u(23)-u(26))^2 + (u(24)-u(27))^2 );
        ...
        if false%(~intactFlag)
            rotTransObj(  R_KneeProsthObj, u(25:27),   u(22:24),   zeros(1,3),   x(22:24))
        ...
        if false%(intactFlag)
            rotTransObj(  R_KneeProsthObj, u(25:27),   u(22:24),   x(25:27),   x(22:24))
